...
namespace PudelkoUnitTests
{
    ...
    public class UnitTestsPudelkoConstructors
    {
        ...
        private void AssertPudelko(PudelkoModel p, double expectedA, double expectedB, double expectedC)
        {
        ...
        {
            PudelkoModel p = new PudelkoModel();
        ...
        {
            PudelkoModel p = new PudelkoModel(a, b, c);
        ...
        public void Constructor_3params_InMeters(double a, double b, double c,
                                                      double expectedA, double expectedB, double expectedC)
        {
            PudelkoModel p = new PudelkoModel(a, b, c, unit: UnitOfMeasure.meter);
        ...
        public void Constructor_3params_InCentimeters(double a, double b, double c,
                                                      double expectedA, double expectedB, double expectedC)
        {
            PudelkoModel p = new PudelkoModel(a: a, b: b, c: c, unit: UnitOfMeasure.centimeter);
        ...
        public void Constructor_3params_InMilimeters(double a, double b, double c,
                                                     double expectedA, double expectedB, double expectedC)
        {
            PudelkoModel p = new PudelkoModel(unit: UnitOfMeasure.milimeter, a: a, b: b, c: c);
        ...
        {
            PudelkoModel p = new PudelkoModel(a, b);
        ...
        {
            PudelkoModel p = new PudelkoModel(a: a, b: b, unit: UnitOfMeasure.meter);
        ...
        {
            PudelkoModel p = new PudelkoModel(unit: UnitOfMeasure.centimeter, a: a, b: b);
        ...
        {
            PudelkoModel p = new PudelkoModel(unit: UnitOfMeasure.milimeter, a: a, b: b);
        ...
        {
            PudelkoModel p = new PudelkoModel(a);
        ...
        {
            PudelkoModel p = new PudelkoModel(unit: UnitOfMeasure.centimeter, a: a);
        ...
        {
            PudelkoModel p = new PudelkoModel(unit: UnitOfMeasure.milimeter, a: a);
        ...
        {
            PudelkoModel p = new PudelkoModel(a, b, c, unit: UnitOfMeasure.centimeter);
        }
        ...
        {
            PudelkoModel p = new PudelkoModel(a, b, c, unit: UnitOfMeasure.milimeter);
        }
        ...
        {
            PudelkoModel p = new PudelkoModel(a, b, unit: UnitOfMeasure.meter);
        }
        ...
        {
            PudelkoModel p = new PudelkoModel(a, b, unit: UnitOfMeasure.centimeter);
        }
        ...
        {
            PudelkoModel p = new PudelkoModel(a, b, unit: UnitOfMeasure.milimeter);
        }
        ...
        {
            PudelkoModel p = new PudelkoModel(a, unit: UnitOfMeasure.meter);
        }
        ...
        {
            PudelkoModel p = new PudelkoModel(a, unit: UnitOfMeasure.centimeter);
        }
        ...
        {
            PudelkoModel p = new PudelkoModel(a, unit: UnitOfMeasure.milimeter);
        }
        ...
        {
            var p = new PudelkoModel(a, b, c, unit: UnitOfMeasure.meter);
        ...
        {
            var p = new PudelkoModel(1, 2.1, 3.231);
            double[] tab = (double[])p;
